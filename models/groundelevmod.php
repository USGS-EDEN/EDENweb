...
<head>
  <meta charset="utf-8">
  <title>Ground Elevation Model - Everglades Depth Estimation Network (EDEN)</title>
    ...
    <td style="vertical-align:top;width:100%;border:0px"><!--Begin body of page -->
      ...
      <div style="width:230px;border:1px solid #710a11;background-color:#f4e1b4;float:left;font-size:12px;padding:2px;margin-right:10px">
        ...
        <ul>
          ...
          <li>&quot;<a href="../../publications/ofr/2007-1034/">Initial Everglades Depth Estimation Network (EDEN) Digital Elevation Model Research and Development</a>&quot; (<abbr title="United States Geological Survey">USGS</abbr> Open File Report 2007-1034)</li>
          <li>&quot;<a href="../../publications/ofr/2007-1200/">Conceptual design of the <abbr title="Everglades Depth Estimation Network">Everglades Depth Estimation Network (EDEN)</abbr> grid</a>&quot; (<abbr title="United States Geological Survey">USGS</abbr> Open File Report 2007-1200).</li>
        </ul>
      </div>
      ...
      <div style="width:600px;border:3px solid #4b7e83;margin:10px auto">
        <table>
          <tr>
          ...
          <tr>
            <td style="width:40%"><a href="../images/maps/EDEN_oc11_release_graphic_lg.gif"><img src="../images/maps/EDEN_oc11_release_graphic_s.gif" alt="Thumbnail image of EDEN Digital Elevation Model map" border="0" height="288" width="191"></a></td>
